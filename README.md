...
Our goal is to develop a **diagnostic toolkit**—a set of benchmarks that help us understand not just whether LLMs can generate working solvers, but how they think through the problem, revealing both strengths and failure modes in reasoning.

📌 **Contributors are invited to co-author the final PDE-Dx paper.** We welcome submissions of challenging tasks and use cases.
